...
/*   Updated: 2016/03/10 04:33:17 by fjanoty          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	dprintf(1, "ang:%f", angle);
	...
	matrix_buffer(color);
	matrix_put_in(0, 0,255, 1);
	matrix_buffer(color2);
	matrix_put_in(255, 0, 0, 1);
	matrix_buffer(color3);
	matrix_put_in(0, 255, 0, 1);
	/*
	color2->m[R] = 255;
	color2->m[G] = 255;
	color2->m[B] = 255;
...
/*	
//	if (!(mat_line = init_mat_line(pt1, pt3, color, color2)))
//		dprintf(1, "\n\nAll is well 2\n");
//		dprintf(1, "\n\nAll is well 2\n");
//	draw_line(e, mat_line);
	...
	if (!(mat_line = init_mat_line(pt1, pt4, color, color3)))
//	if (!(mat_line = init_mat_line(pt4, pt1, color, color3)))
		dprintf(1, "All is well 3\n");
	draw_line(e, (mat_line));
	//draw_line(e, mat_line);

	matrix_free(&mat_line);
	if (!(mat_line = init_mat_line(pt1, pt5, color, color2)))
		dprintf(1, "All is well 3\n");
	draw_line(e, (mat_line));
//	draw_line(e, mat_line);
//		dprintf(1, "All is well 3\n");
