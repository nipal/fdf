...
void	key_release_end(int keycode, t_env *e)
{
	...
	(keycode == '1') ? e->key.decal_down = 0 : (void)keycode;
	(keycode == '2') ? e->key.decal_up = 0 : (void)keycode;
	(keycode == '3') ? e->key.decal_right = 0 : (void)keycode;
	(keycode == '4') ? e->key.decal_down = 0 : (void)keycode;
	(keycode == '5') ? e->key.decal_up = 0 : (void)keycode;
	(keycode == '6') ? e->key.decal_right = 0 : (void)keycode;
	(keycode == '7') ? e->key.decal_left = 0 : (void)keycode;
	(keycode == '8') ? e->key.zoom = 0 : (void)keycode;
	(keycode == '9') ? e->key.zoom_back = 0 : (void)keycode;
	(keycode == '1') ? e->key.scale_increase = 0 : (void)keycode;
	(keycode == '1') ? e->key.scale_decrease = 0 : (void)keycode;
	(keycode == '1') ? e->key.cte1_increase = 0 : (void)keycode;
	(keycode == '1') ? e->key.cte1_decrease = 0 : (void)keycode;
	(keycode == '1') ? e->key.isometric = 0 : (void)keycode;
	(keycode == '1') ? e->key.parallel = 0 : (void)keycode;
	(keycode == '1') ? e->key.conic = 0 : (void)keycode;
	(keycode == '1') ? e->key.r = 0 : (void)keycode;
	(keycode == '1') ? e->key.g = 0 : (void)keycode;
	(keycode == '1') ? e->key.b = 0 : (void)keycode;
/*
...
{
	(keycode == 'n') ? e->key.view = 0 : (void)keycode;
	(keycode == 'm') ? e->key.draw = 0 : (void)keycode;
	(keycode == 'z') ? e->key.fi1 = 0 : (void)keycode;
	(keycode == 'x') ? e->key.fi_1 = 0 : (void)keycode;
	(keycode == 'c') ? e->key.fi2 = 0 : (void)keycode;
	(keycode == 'v') ? e->key.fi_2 = 0 : (void)keycode;
	(keycode == '-') ? e->key.speed_down = 0 : (void)keycode;
	(keycode == '=') ? e->key.speed_up = 0 : (void)keycode;
	(keycode == '0') ? e->key.speed_stop = 0 : (void)keycode;
	(keycode == 'w') ? e->key.rot_x1 = 0 : (void)keycode;
	(keycode == 'q') ? e->key.rot_y1 = 0 : (void)keycode;
	(keycode == 'a') ? e->key.rot_z1 = 0 : (void)keycode;
	(keycode == 's') ? e->key.rot_x2 = 0 : (void)keycode;
	(keycode == 'e') ? e->key.rot_y2 = 0 : (void)keycode;
	(keycode == 'd') ? e->key.rot_z2 = 0 : (void)keycode;
	(keycode == 'i') ? e->key.rot_cam_x1 = 0 : (void)keycode;
	(keycode == 'u') ? e->key.rot_cam_y1 = 0 : (void)keycode;
	(keycode == 'j') ? e->key.rot_cam_z1 = 0 : (void)keycode;
	(keycode == 'k') ? e->key.rot_cam_x2 = 0 : (void)keycode;
	(keycode == 'o') ? e->key.rot_cam_y2 = 0 : (void)keycode;
	(keycode == 'l') ? e->key.rot_cam_z2 = 0 : (void)keycode;
